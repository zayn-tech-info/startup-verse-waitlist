...
const LANDING_HTML = `
  ...
  <nav>
    ...
    <ul class="nav-links">
      ...
      <li><a href="#register" class="nav-cta">Reserve Spot &rarr;</a></li>
    </ul>
    ...
    <div class="mobile-menu-overlay" id="mobile-menu-overlay">
      ...
      <ul class="mobile-nav-links">
        ...
        <li><a href="#register" class="mobile-nav-cta">Reserve Spot &rarr;</a></li>
      </ul>
    </div>
  </nav>
  ...
  <header class="hero">
    ...
    <p class="hero-sub fu fu3" style="margin-bottom:0">
      Free to attend. Saturday, 6 June 2026. The Assembly, Ogbomoso.
    </p>
    ...
    <div class="hero-btns fu fu5">
      <a href="#register" class="btn-primary">Reserve my spot &rarr;</a>
  ...
  <section id="register" class="form-section">
    <div class="section-inner">
      ...
      <div class="form-card reveal">
        <div id="form-body">
          <p class="form-sub">#BuildWithStartupVerse &middot; Free admission &middot; 6 June 2026</p>
        ...
        <div class="success-state" id="success-state">
          ...
          <p>We'll see you on 6th of June.<br>Check your email - we'll send you everything you need before the event.</p>
  ...
  <footer>
    <div class="footer-inner">
      ...
      <p class="footer-tag"><strong>#BuildWithStartupVerse</strong> &middot; The Assembly, Ogbomoso, Oyo State</p>
...
export default function LandingPage() {
  ...
  useEffect(() => {
    const target = new Date("2026-06-06T09:00:00+01:00").getTime();
